...
path.measure = "/Users/christophermims/Documents/WSU/Fall\ 2020/STATS\ 419";
...
covariates = read_excel(paste0(path.measure,"/","measure_mims_c.xlsx"), sheet="covariates");
panel = read_excel(paste0(path.measure,"/","measure_mims_c.xlsx"), sheet="panel");
...
path.your.measure.file = "/Users/christophermims/Documents/WSU/Fall\ 2020/STATS\ 419";  
  # change this to wherever measure.xls lives for you...  
  # YOU SHOULD USE MINE IN THE DROPBOX AS THE EXAMPLE...
  # BELOW, we will import yours ...


covariates = read_excel(paste0(path.your.measure.file,"/","measure_mims_c.xlsx"), sheet="covariates");
panel = read_excel(paste0(path.your.measure.file,"/","measure_mims_c.xlsx"), sheet="panel");
...
collector = "789951a2bbfbf299b0822cc8452f236f";
path.git = "/User/christophermims/_git_/WSU_STATS419_FALL2020/WEEK-05/datasets"
outfile = paste0(path.git,"/","measure","-",collector,".txt");
