...
\newcommand{\hmwkAuthor}{Christopher Mims}
\newcommand{\hmwkEmail}{\href{mailto:chirs24m@wsu.edu}{\nolinkurl{chirs24m@wsu.edu}}}
\newcommand{\hmwkWSU}{[]}
\newcommand{\hmwkInstructor}{Instructor: Monte J. Shaffer}
\newcommand{\hmwkDate}{`r format(Sys.time(),'\%d \%B \%Y')'}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(devtools); }\CommentTok{# devtools is required for function source_url() to work}
\NormalTok{my.source =}\StringTok{ 'github'}\NormalTok{;}
\NormalTok{github.path =}\StringTok{ "https://raw.githubusercontent.com/DataChris24/WSU_STATS419_FALL2020/"}\NormalTok{;}
\KeywordTok{source_url}\NormalTok{( }\KeywordTok{paste0}\NormalTok{(github.path,}\StringTok{"master/functions/libraries.R"}\NormalTok{) );}
\KeywordTok{source_url}\NormalTok{( }\KeywordTok{paste0}\NormalTok{(github.path,}\StringTok{"master/functions/functions-imdb.R"}\NormalTok{) );}
\end{Highlighting}
\end{Shaded}
